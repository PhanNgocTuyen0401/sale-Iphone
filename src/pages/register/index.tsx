    ...
    >
      ...
      >
        ...
        <form className="flex gap-4">
          <div className="w-1/2">
            {/* Input: Username */}  <label className="text-gray-400 text-sm">Họ và tên</label><span className="ml-1 text-red-500">*</span>
            <div className="mb-4 mt-1">
              ...
              />
            </div>    <label className="text-gray-400 text-sm">Email</label><span className="ml-1 text-red-500">*</span>
            <div className="mb-4 mt-1">
              <Input
                placeholder="Email"
                className="w-full p-3 rounded-lg bg-white bg-opacity-20 
              ...
              />
            </div> <label className="text-gray-400 text-sm">Địa chỉ</label><span className="ml-1 text-red-500">*</span>
            <div className="mb-4 mt-1">
              <Input
                placeholder="Địa chỉ"
                className="w-full p-3 rounded-lg bg-white bg-opacity-20 
          ...
          <div className="w-1/2"> <label className="text-gray-400 text-sm">Số điện thoại</label><span className="ml-1 text-red-500">*</span>
            <div className="mb-4 mt-1">
              <Input
            ...
            {/* Input: Password */} <label className="text-gray-400 text-sm">Mật khẩu</label><span className="ml-1 text-red-500">*</span>
            <div className="mb-4 mt-1">
              <Input.Password
            ...
            {/* Input: Confirm Password */}   <label className="text-gray-400 text-sm">Xác nhận mật khẩu</label><span className="ml-1 text-red-500">*</span>
            <div className="mb-4 mt-1">
              <Input.Password
        ...
        <button
          ...
          type="submit"
          className="w-full p-3 bg-green-100 text-green-600 mt-4 rounded-lg font-bold 
