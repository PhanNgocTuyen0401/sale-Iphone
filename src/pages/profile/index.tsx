    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-blue-100 to-indigo-50">
            ...
            <div className="px-6 py-4">
                <h1 className="text-2xl font-bold text-gray-800">Welcome, Tẻn</h1>
                <p className="text-sm text-gray-500">Tue, 13 June 2025</p>
            </div>
            ...
            <div className="max-w-5xl mx-auto bg-white rounded-2xl shadow-lg border px-8 py-8">
                ...
                <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-8 gap-6">
                    ...
                    <div className="flex items-center space-x-5">
                        ...
                        />
                        <div>
                            <h2 className="text-xl font-semibold text-gray-900">Tẻn Tẻn</h2>
