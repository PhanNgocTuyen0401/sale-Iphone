            ...
            <div className="bg-white rounded-lg shadow-sm border p-6 sticky top-24">
              ...
              <div className="space-y-3 mb-6">
                <div className="flex justify-between text-sm">
                  ...
                  <span className="text-gray-900">{(productDetail?.price as number) * quantityOrder}</span>
                </div>
                <div className="flex justify-between text-sm">
                ...
                <div className="border-t border-gray-200 pt-3">
                  <div className="flex justify-between">
                    ...
                    <span className="text-lg font-semibold text-red-600">
                      ...
                      {(productDetail?.price as number) * quantityOrder + 30000}đ
                    </span>
                  </div>
                </div>
              </div>
              ...
              <button onClick={handleOrderProduct} className="w-full bg-blue-600 text-white py-3 px-6 rounded-lg font-medium hover:bg-blue-700 transition-colors cursor-pointer !rounded-button whitespace-nowrap">
