          ...
          <div className="bg-white rounded-lg shadow-md p-6 sticky top-24">
            ...
            <div className="mb-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  <h4 className="font-medium text-gray-700 mb-2">Card đồ họa</h4>
                  <Select
                    showSearch
                    placeholder="Chọn cấu hình"
                    optionFilterProp="label"
            ...
            <button
              className="w-full py-2 bg-gray-200 text-gray-700 rounded-md hover:bg-gray-300 transition-colors cursor-pointer whitespace-nowrap"
            >
              Xóa bộ lọc
            </button>
          </div>
